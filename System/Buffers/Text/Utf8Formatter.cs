...
namespace System.Buffers.Text
{
	internal static class Utf8Formatter
	{
		...
		public static bool TryFormat(bool value, Span<byte> destination, out int bytesWritten, StandardFormat format = default(StandardFormat))
		{
			...
			return true;
			IL_0083:
			return _003C805945f3_002D27b0_002D47ad_002Db8f6_002D389d9d8f82c3_003EThrowHelper.TryFormatThrowFormatException(out bytesWritten);
			IL_006e:
			destination[4] = 101;
			bytesWritten = 5;
			return true;
		...
		public static bool TryFormat(DateTimeOffset value, Span<byte> destination, out int bytesWritten, StandardFormat format = default(StandardFormat))
		{
			...
			return c switch
			{
				...
				_ => _003C805945f3_002D27b0_002D47ad_002Db8f6_002D389d9d8f82c3_003EThrowHelper.TryFormatThrowFormatException(out bytesWritten), 
			};
		}
		...
		public static bool TryFormat(decimal value, Span<byte> destination, out int bytesWritten, StandardFormat format = default(StandardFormat))
		{
			...
			case 'g':
			{
				...
				{
					throw new NotSupportedException(_003C805945f3_002D27b0_002D47ad_002Db8f6_002D389d9d8f82c3_003ESR.Argument_GWithPrecisionNotSupported);
				}
