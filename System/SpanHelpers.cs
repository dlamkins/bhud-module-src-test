...
namespace System
{
	internal static class SpanHelpers
	{
		...
		public static int BinarySearch<T, TComparable>(this ReadOnlySpan<T> span, TComparable comparable) where TComparable : IComparable<T>
		{
			if (comparable == null)
			{
				_003C805945f3_002D27b0_002D47ad_002Db8f6_002D389d9d8f82c3_003EThrowHelper.ThrowArgumentNullException(_003C805945f3_002D27b0_002D47ad_002Db8f6_002D389d9d8f82c3_003EExceptionArgument.comparable);
			}
		...
		public unsafe static void CopyTo<T>(ref T dst, int dstLength, ref T src, int srcLength)
		{
			...
			if (!((sizeof(IntPtr) != 4) ? ((ulong)(long)intPtr3 < (ulong)(long)intPtr || (ulong)(long)intPtr3 > (ulong)(-(long)intPtr2)) : ((uint)(int)intPtr3 < (uint)(int)intPtr || (uint)(int)intPtr3 > (uint)(-(int)intPtr2))) && !IsReferenceOrContainsReferences<T>())
			{
				ref byte source = ref Unsafe.As<T, byte>(ref dst);
				ref byte source2 = ref Unsafe.As<T, byte>(ref src);
				ulong num = (ulong)(long)intPtr;
				uint num3;
				for (ulong num2 = 0uL; num2 < num; num2 += num3)
				{
					num3 = (uint)((num - num2 > uint.MaxValue) ? uint.MaxValue : (num - num2));
