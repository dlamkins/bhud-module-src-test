...
{
	internal readonly struct Measurement<T> where T : struct
	{
		private readonly KeyValuePair<string, object>[] _tags;

		public ReadOnlySpan<KeyValuePair<string, object?>> Tags => (ReadOnlySpan<KeyValuePair<string, object>>)_tags.AsSpan();
