...
namespace System.Diagnostics.Metrics
{
	internal sealed class Histogram<T> : Instrument<T> where T : struct
	{
		...
		internal Histogram(Meter meter, string name, string unit, string description, IEnumerable<KeyValuePair<string, object>> tags)
		...
		{
			RecordMeasurement(value, (ReadOnlySpan<KeyValuePair<string, object>>)tags.AsSpan());
		}
