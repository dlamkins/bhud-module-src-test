...
namespace System.Diagnostics.Metrics
{
	internal class Meter : IDisposable
	{
		...
		public Counter<T> CreateCounter<T>(string name, string? unit, string? description, IEnumerable<KeyValuePair<string, object?>>? tags) where T : struct
		{
			...
			IEnumerable<KeyValuePair<string, object>> tags2 = tags;
			return (Counter<T>)GetOrCreateInstrument<T>(typeof(Counter<T>), name2, unit2, description2, tags2, () => new Counter<T>(this, name2, unit2, description2, tags2));
		}
		...
		public Histogram<T> CreateHistogram<T>(string name, string? unit, string? description, IEnumerable<KeyValuePair<string, object?>>? tags) where T : struct
		{
			...
			string description2 = description;
			IEnumerable<KeyValuePair<string, object>> tags2 = tags;
			return (Histogram<T>)GetOrCreateInstrument<T>(typeof(Histogram<T>), name2, unit2, description2, tags2, () => new Histogram<T>(this, name2, unit2, description2, tags2));
		}
		...
		public UpDownCounter<T> CreateUpDownCounter<T>(string name, string? unit, string? description, IEnumerable<KeyValuePair<string, object?>>? tags) where T : struct
		{
			...
			string description2 = description;
			IEnumerable<KeyValuePair<string, object>> tags2 = tags;
			return (UpDownCounter<T>)GetOrCreateInstrument<T>(typeof(UpDownCounter<T>), name2, unit2, description2, tags2, () => new UpDownCounter<T>(this, name2, unit2, description2, tags2));
		}
