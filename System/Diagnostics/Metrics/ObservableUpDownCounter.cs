...
namespace System.Diagnostics.Metrics
{
	internal sealed class ObservableUpDownCounter<T> : ObservableInstrument<T> where T : struct
	{
		...
		internal ObservableUpDownCounter(Meter meter, string name, Func<T> observeValue, string unit, string description, IEnumerable<KeyValuePair<string, object>> tags)
		...
		internal ObservableUpDownCounter(Meter meter, string name, Func<Measurement<T>> observeValue, string unit, string description, IEnumerable<KeyValuePair<string, object>> tags)
			: base(meter, name, unit, description, tags)
		{
			_callback = observeValue ?? throw new ArgumentNullException("observeValue");
			Publish();
		...
		internal ObservableUpDownCounter(Meter meter, string name, Func<IEnumerable<Measurement<T>>> observeValues, string unit, string description, IEnumerable<KeyValuePair<string, object>> tags)
			: base(meter, name, unit, description, tags)
		{
