	...
	internal sealed class HttpHandlerDiagnosticListener : DiagnosticListener
	{
			...
			public override object this[object key]
			{
				...
				set
				{
					...
					if (weakReference != null && weakReference.IsAlive)
					{
						...
						{
							Hashtable hashtable = s_connectionGroupListField.GetValue(servicePoint) as Hashtable;
							ConnectionGroupHashtable value2 = new ConnectionGroupHashtable(hashtable ?? new Hashtable());
							s_connectionGroupListField.SetValue(servicePoint, value2);
						}
					}
					base[key] = value;
				}
		...
		private sealed class HttpWebRequestArrayList : ArrayListWrapper
		{
			...
			public override int Add(object value)
			{
				...
				{
					s_instance.RaiseRequestEvent(httpWebRequest);
				}
				return base.Add(value);
			}
		...
		private static void PrepareReflectionObjects()
		{
			...
			{
				throw new InvalidOperationException(_003Cd09c9507_002D1983_002D461f_002D8fce_002Df8aba78858d6_003ESR.UnableToInitialize);
			}
		}
		...
		private static void PerformInjection()
		{
			...
			if (field == null)
			{
				throw new InvalidOperationException(_003Cd09c9507_002D1983_002D461f_002D8fce_002Df8aba78858d6_003ESR.UnableAccessServicePointTable);
			}
