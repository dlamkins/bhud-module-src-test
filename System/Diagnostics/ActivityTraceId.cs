...
{
	internal readonly struct ActivityTraceId : IEquatable<ActivityTraceId>
	{
		...
		public static ActivityTraceId CreateFromBytes(ReadOnlySpan<byte> idData)
		{
			...
			return new ActivityTraceId(_003Cd09c9507_002D1983_002D461f_002D8fce_002Df8aba78858d6_003EHexConverter.ToString(idData, _003Cd09c9507_002D1983_002D461f_002D8fce_002Df8aba78858d6_003EHexConverter.Casing.Lower));
		}
		...
		private ActivityTraceId(ReadOnlySpan<byte> idData)
		{
			...
			_hexString = _003Cd09c9507_002D1983_002D461f_002D8fce_002Df8aba78858d6_003EHexConverter.ToString(MemoryMarshal.AsBytes(span), _003Cd09c9507_002D1983_002D461f_002D8fce_002Df8aba78858d6_003EHexConverter.Casing.Lower);
		}
		...
		{
			int num = _003Cd09c9507_002D1983_002D461f_002D8fce_002Df8aba78858d6_003EHexConverter.FromLowerChar(char1);
			int num2 = _003Cd09c9507_002D1983_002D461f_002D8fce_002Df8aba78858d6_003EHexConverter.FromLowerChar(char2);
			if ((num | num2) == 255)
			{
				throw new ArgumentOutOfRangeException("idData");
			}
		...
		internal static bool IsLowerCaseHexAndNotAllZeros(ReadOnlySpan<char> idData)
		{
			...
			{
				char c = idData[i];
				if (!_003Cd09c9507_002D1983_002D461f_002D8fce_002Df8aba78858d6_003EHexConverter.IsHexLowerChar(c))
				{
					return false;
				}
				if (c != '0')
