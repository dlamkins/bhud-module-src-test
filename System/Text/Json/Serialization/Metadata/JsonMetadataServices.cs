...
namespace System.Text.Json.Serialization.Metadata
{
	...
	internal static class JsonMetadataServices
	{
		...
		internal static JsonConverter<T> GetTypedConverter<T>(JsonConverter converter) where T : notnull
		{
			JsonConverter<T> jsonConverter = converter as JsonConverter<T>;
			if (jsonConverter == null)
			{
				throw new InvalidOperationException(_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ESR.Format(_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ESR.SerializationConverterNotCompatible, jsonConverter, typeof(T)));
			}
		...
		public static JsonPropertyInfo CreatePropertyInfo<T>(JsonSerializerOptions options, JsonPropertyInfoValues<T> propertyInfo)
		{
			...
			{
				throw new InvalidOperationException(_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ESR.Format(_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ESR.FieldCannotBeVirtual, "IsProperty", "IsVirtual"));
			}
