	...
	internal sealed class FSharpTypeConverterFactory : JsonConverterFactory
	{
		...
		public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
		{
			...
			case FSharpCoreReflectionProxy.FSharpKind.Union:
				return UnsupportedTypeConverterFactory.CreateUnsupportedConverterForType(typeToConvert, _003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ESR.FSharpDiscriminatedUnionsNotSupported);
			default:
				throw new Exception();
			}
