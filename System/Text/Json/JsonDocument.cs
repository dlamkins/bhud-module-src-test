...
namespace System.Text.Json
{
	internal sealed class JsonDocument : IDisposable
	{
		...
		internal bool TryGetValue(int index, [_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ENotNullWhen(true)] out byte[] value)
		{
			CheckNotDisposed();
			DbRow dbRow = _parsedData.Get(index);
		...
		private static void CheckSupportedOptions(JsonReaderOptions readerOptions, string paramName)
		{
			...
			{
				throw new ArgumentException(_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ESR.JsonDocumentDoesNotSupportComments, paramName);
			}
		}
		...
		public static bool TryParseValue(ref Utf8JsonReader reader, [_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ENotNullWhen(true)] out JsonDocument? document)
		{
		...
		internal static bool TryParseValue(ref Utf8JsonReader reader, [_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ENotNullWhen(true)] out JsonDocument document, bool shouldThrow, bool useArrayPools)
		{
