...
namespace System.Text.Json
{
	...
	internal sealed class Utf8JsonWriter : IDisposable, IAsyncDisposable
	{
		...
		public Utf8JsonWriter(Stream utf8Json, JsonWriterOptions options = default(JsonWriterOptions))
		{
			...
			{
				throw new ArgumentException(_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ESR.StreamNotWritable);
			}
			_stream = utf8Json;
			_options = options;
			if (_options.MaxDepth == 0)
		...
		private void WriteStringEscapeProperty([ScopedRef] ReadOnlySpan<char> propertyName, int firstEscapeIndexProp)
		{
			char[] array = null;
		...
		private void WriteStringEscapeProperty([ScopedRef] ReadOnlySpan<byte> utf8PropertyName, int firstEscapeIndexProp)
		{
			byte[] array = null;
			if (firstEscapeIndexProp != -1)
			{
		...
		private void WriteStringEscapePropertyOrValue([ScopedRef] ReadOnlySpan<char> propertyName, [ScopedRef] ReadOnlySpan<char> value, int firstEscapeIndexProp, int firstEscapeIndexVal)
		{
			char[] array = null;
			char[] array2 = null;
		...
		private void WriteStringEscapePropertyOrValue([ScopedRef] ReadOnlySpan<byte> utf8PropertyName, [ScopedRef] ReadOnlySpan<byte> utf8Value, int firstEscapeIndexProp, int firstEscapeIndexVal)
		{
			byte[] array = null;
			byte[] array2 = null;
			if (firstEscapeIndexVal != -1)
		...
		private void WriteStringEscapePropertyOrValue([ScopedRef] ReadOnlySpan<char> propertyName, [ScopedRef] ReadOnlySpan<byte> utf8Value, int firstEscapeIndexProp, int firstEscapeIndexVal)
		{
			byte[] array = null;
			char[] array2 = null;
			if (firstEscapeIndexVal != -1)
		...
		private void WriteStringEscapePropertyOrValue([ScopedRef] ReadOnlySpan<byte> utf8PropertyName, [ScopedRef] ReadOnlySpan<char> value, int firstEscapeIndexProp, int firstEscapeIndexVal)
		{
			char[] array = null;
			byte[] array2 = null;
			if (firstEscapeIndexVal != -1)
		...
		public void WriteRawValue(ReadOnlySequence<byte> utf8Json, bool skipInputValidation = false)
		{
			...
			if (length == 0L)
			{
				ThrowHelper.ThrowArgumentException(_003C040126af_002Deea0_002D4cbb_002Db0ec_002D5483efb85291_003ESR.ExpectedJsonTokens);
			}
