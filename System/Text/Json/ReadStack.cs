	...
	internal struct ReadStack
	{
		...
		public string JsonPath()
		{
			...
			static void AppendStackFrame(StringBuilder sb, ref ReadStackFrame frame)
			{
				...
				{
					IEnumerable enumerable2 = frame.ReturnValue as IEnumerable;
					if (enumerable2 != null && (frame.ObjectState == StackFrameObjectState.None || frame.ObjectState == StackFrameObjectState.CreatedObject || frame.ObjectState == StackFrameObjectState.ReadElements))
					{
						sb.Append('[');
