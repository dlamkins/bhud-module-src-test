				...
				static int TryEncodeScalarAsHex(object @this, Rune value, Span<byte> destination)
				{
					if (value.IsBmp)
					{
						if (SpanUtility.IsValidIndex(destination, 5))
						{
							destination[0] = 92;
							destination[1] = 117;
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)value.Value, destination, 4);
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)((uint)value.Value >> 8), destination, 2);
							return 6;
						}
					}
					else
					{
						...
						if (SpanUtility.IsValidIndex(destination, 11))
						{
							destination[0] = 92;
							destination[1] = 117;
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)highSurrogate, destination, 4);
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)((uint)highSurrogate >> 8), destination, 2);
							destination[6] = 92;
							destination[7] = 117;
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)lowSurrogate, destination, 10);
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)((uint)lowSurrogate >> 8), destination, 8);
							return 12;
						}
					}
					return -1;
				...
				static int TryEncodeScalarAsHex(object @this, Rune value, Span<char> destination)
				{
					if (value.IsBmp)
					{
						if (SpanUtility.IsValidIndex(destination, 5))
						{
							destination[0] = '\\';
							destination[1] = 'u';
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)value.Value, destination, 4);
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)((uint)value.Value >> 8), destination, 2);
							return 6;
						}
					}
					else
					{
						...
						if (SpanUtility.IsValidIndex(destination, 11))
						{
							destination[0] = '\\';
							destination[1] = 'u';
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)highSurrogate, destination, 4);
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)((uint)highSurrogate >> 8), destination, 2);
							destination[6] = '\\';
							destination[7] = 'u';
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)lowSurrogate, destination, 10);
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)((uint)lowSurrogate >> 8), destination, 8);
							return 12;
						}
					}
					return -1;
