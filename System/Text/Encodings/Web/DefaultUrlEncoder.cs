	...
	internal sealed class DefaultUrlEncoder : UrlEncoder
	{
		private sealed class EscaperImplementation : ScalarEscaperBase
		{
			...
			internal override int EncodeUtf8(Rune value, Span<byte> destination)
			{
				...
				{
					destination[0] = 37;
					_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)utf8RepresentationForScalarValue, destination, 1);
					...
					{
						destination[3] = 37;
						_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)utf8RepresentationForScalarValue, destination, 4);
						if ((utf8RepresentationForScalarValue >>= 8) == 0)
						{
							return 6;
						}
						...
						{
							destination[6] = 37;
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)utf8RepresentationForScalarValue, destination, 7);
							if ((utf8RepresentationForScalarValue >>= 8) == 0)
							{
								return 9;
							}
							...
							{
								destination[9] = 37;
								_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToBytesBuffer((byte)utf8RepresentationForScalarValue, destination, 10);
								return 12;
							}
						}
					}
			...
			internal override int EncodeUtf16(Rune value, Span<char> destination)
			{
				...
				{
					destination[0] = '%';
					_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)utf8RepresentationForScalarValue, destination, 1);
					if ((utf8RepresentationForScalarValue >>= 8) == 0)
					{
						return 3;
					}
					...
					{
						destination[3] = '%';
						_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)utf8RepresentationForScalarValue, destination, 4);
						if ((utf8RepresentationForScalarValue >>= 8) == 0)
						{
							return 6;
						}
						...
						{
							destination[6] = '%';
							_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)utf8RepresentationForScalarValue, destination, 7);
							if ((utf8RepresentationForScalarValue >>= 8) == 0)
							{
								return 9;
							}
							...
							{
								destination[9] = '%';
								_003C34553c85_002Ddaa9_002D492b_002D9f2f_002D061f10e4aa05_003EHexConverter.ToCharsBuffer((byte)utf8RepresentationForScalarValue, destination, 10);
								return 12;
							}
						}
					}
