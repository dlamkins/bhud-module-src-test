...
namespace MysticCrafting.Module.Recipe.TreeView.Tooltips
{
	public class ItemTooltipView : View, ITooltipView, IView
	{
		...
		private Label RequiredQuantityLabel { get; set; }
		...
		public int PlayerItemCount
		{
			...
			set
			{
				...
				if (RequiredQuantityLabel != null)
				{
					RequiredQuantityLabel.Text = string.Format(MysticCrafting.Module.Strings.Recipe.MoreRequired, RequiredQuantity.ToString("N0"));
				}
			}
		}
