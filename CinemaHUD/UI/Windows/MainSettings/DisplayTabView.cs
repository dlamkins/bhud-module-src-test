...
namespace CinemaHUD.UI.Windows.MainSettings
{
	public class DisplayTabView : View
	{
		...
		private void PopulateCategoryMenu()
		{
			...
			_categoryMenu.AddMenuItem("My Locations", (Texture2D)null).set_Icon(global::CinemaModule.CinemaModule.Instance.TextureService.GetEmblem());
		...
		private void BuildMyLocationsToolbar()
		{
			...
			val3.set_Icon(global::CinemaModule.CinemaModule.Instance.TextureService.GetImportIcon());
		...
		private void CreatePresetLocationCard(WorldLocationPresetData preset)
		{
			...
			if (!string.IsNullOrEmpty(preset.Waypoint))
			{
				buttons.Insert(0, new ListCardButton
				{
					Text = "",
					Width = 30,
					Icon = global::CinemaModule.CinemaModule.Instance.TextureService.GetWaypointIcon(),
