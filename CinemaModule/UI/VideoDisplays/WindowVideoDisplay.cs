...
namespace CinemaModule.UI.VideoDisplays
{
	public class WindowVideoDisplay : Panel, IVideoDisplay, IDisposable
	{
		...
		public bool IsPaused
		{
			get
			{
				return _controlsOverlay.IsPaused;
			}
			set
			{
		...
		public int Volume
		{
			get
			{
				return _controlsOverlay.Volume;
			}
			set
			{
		...
		public bool IsTwitchStream
		{
			get
			{
				return _controlsOverlay.IsTwitchStream;
			}
			set
			{
		...
		public bool IsSeekable
		{
			get
			{
				return _controlsOverlay.IsSeekable;
			}
			set
			{
				_controlsOverlay.IsSeekable = value;
			}
		}
		...
		public float CurrentPosition
		{
			get
			{
				return _controlsOverlay.CurrentPosition;
			}
			set
			{
				_controlsOverlay.CurrentPosition = value;
			}
		}
		...
		public long Duration
		{
			get
			{
				return _controlsOverlay.Duration;
			}
			set
			{
				_controlsOverlay.Duration = value;
			}
		}
		...
		public bool IsLocked
		{
			get
			{
				return _controlsOverlay.IsLocked;
			}
			set
			{
				_controlsOverlay.IsLocked = value;
			}
		}
		...
		public string StreamTitle
		{
			get
			{
				return _controlsOverlay.StreamTitle;
			}
			set
			{
				_controlsOverlay.StreamTitle = value;
			}
		}
		...
		public int? ViewerCount
		{
			get
			{
				return _controlsOverlay.ViewerCount;
			}
			set
			{
				_controlsOverlay.ViewerCount = value;
			}
		}
		...
		public string GameName
		{
			get
			{
				return _controlsOverlay.GameName;
			}
			set
			{
				_controlsOverlay.GameName = value;
			}
		}
		...
		public Point Size
		{
			...
			set
			{
				...
				((Point)(ref newSize))._002Ector(clampedWidth, calculatedHeight);
				((Control)this).set_Size(newSize);
				Point reclampedLocation = ClampToScreenBounds(((Control)this).get_Location(), newSize);
				if (reclampedLocation != ((Control)this).get_Location())
				{
					((Control)this).set_Location(reclampedLocation);
				}
			}
		}
			...
			: this()
		{
			...
			_controlsOverlay.SeekRequested += delegate(object s, float pos)
			{
				this.SeekRequested?.Invoke(this, pos);
			};
			_controlsOverlay.LockToggled += delegate(object s, bool locked)
			{
		...
		private void DrawOfflineTexture(SpriteBatch spriteBatch, Rectangle videoRect)
		{
			...
			{
				int height = (int)((float)videoRect.Width / textureAspect);
				((Rectangle)(ref destRect))._002Ector(videoRect.X, videoRect.Y + (videoRect.Height - height) / 2, videoRect.Width, height);
			}
			else
			{
		...
		protected override void OnLeftMouseButtonPressed(MouseEventArgs e)
		{
			...
			Point mousePos = GameService.Input.get_Mouse().get_Position();
			if ((_controlsOverlay == null || !_controlsOverlay.HandleMouseDown(mousePos)) && !IsLocked)
			{
		...
		public override void UpdateContainer(GameTime gameTime)
		{
			...
			((Control)this).set_BasicTooltipText(_controlsOverlay.CurrentTooltip);
		}
		...
		private Point ClampToScreenBounds(Point location, Point size)
		{
			...
			int minY = 35;
			int maxX = Math.Max(0, screenWidth - 100);
			int maxY = Math.Max(minY, screenHeight - 100);
			int num = Math.Max(0, Math.Min(location.X, maxX));
