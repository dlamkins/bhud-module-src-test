...
namespace CinemaModule.UI.Windows.Dialogs
{
	public abstract class SmallWindow : StandardWindow
	{
		...
		private static AsyncTexture2D BackgroundTexture => CinemaModule.Instance.TextureService.GetSmallWindowBackground();
			...
			: this(BackgroundTexture, DefaultWindowRegion, DefaultContentRegion)
		{
			...
			((WindowBase2)this).set_Emblem(AsyncTexture2D.op_Implicit(CinemaModule.Instance.TextureService.GetEmblem()));
