...
namespace CinemaModule.UI.Windows.MainSettings
{
	public class StreamCardFactory
	{
		...
		private List<ListCardButton> CreateTwitchButtons(string channelName)
		{
			...
			{
				CreateIconButton(_textureService.GetInfoIcon(), "Open channel in browser", delegate
				{
					OpenUrl(twitchUrl);
				}),
				CreateIconButton(_textureService.GetTwitchChatIcon(), "Open Twitch chat", delegate
				{
		...
		private List<ListCardButton> CreateChannelButtons(ChannelData channel)
		{
			...
			if (channel.IsTwitchChannel && !string.IsNullOrEmpty(channel.TwitchName))
			{
				...
				buttons.Add(CreateIconButton(_textureService.GetInfoIcon(), "Open channel in browser", delegate
				{
					OpenUrl(twitchUrl);
				}));
				buttons.Add(CreateIconButton(_textureService.GetTwitchChatIcon(), "Open Twitch chat", delegate
				{
			...
			{
				buttons.Add(CreateIconButton(_textureService.GetWaypointIcon(), "Copy waypoint to clipboard", delegate
				{
		...
		{
			List<ListCardButton> buttons = new List<ListCardButton> { CreateIconButton(_textureService.GetDeleteIcon(), "Delete this source", onDelete) };
