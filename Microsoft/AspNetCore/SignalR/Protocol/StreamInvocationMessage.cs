...
{
	internal class StreamInvocationMessage : HubMethodInvocationMessage
	{
		...
		public override string ToString()
		{
			...
			return "StreamInvocation { InvocationId: \"" + base.InvocationId + "\", Target: \"" + base.Target + "\", Arguments: [ " + text + " ], StreamIds: [ " + text2 + " ] }";
		}
	}
}
