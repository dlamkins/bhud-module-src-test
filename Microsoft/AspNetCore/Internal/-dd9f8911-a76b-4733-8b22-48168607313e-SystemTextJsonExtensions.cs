...
{
	internal static class _003Cdd9f8911_002Da76b_002D4733_002D8b22_002D48168607313e_003ESystemTextJsonExtensions
	{
		...
		public static void EnsureObjectStart(this ref Utf8JsonReader reader)
		{
			...
			{
				throw new InvalidDataException("Unexpected JSON Token Type '" + GetTokenString(ref reader) + "'. Expected a JSON Object.");
			}
		}
		...
		public static void EnsureArrayStart(this ref Utf8JsonReader reader)
		{
			...
			{
				throw new InvalidDataException("Unexpected JSON Token Type '" + GetTokenString(ref reader) + "'. Expected a JSON Array.");
			}
		}
