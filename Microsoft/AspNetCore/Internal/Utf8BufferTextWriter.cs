...
namespace Microsoft.AspNetCore.Internal
{
	internal sealed class Utf8BufferTextWriter : TextWriter
	{
		...
		{
			Utf8BufferTextWriter utf8BufferTextWriter = _cachedInstance;
			if (utf8BufferTextWriter == null)
			{
				utf8BufferTextWriter = new Utf8BufferTextWriter();
			}
			_cachedInstance = null;
			utf8BufferTextWriter.SetWriter(bufferWriter);
			return utf8BufferTextWriter;
		}
