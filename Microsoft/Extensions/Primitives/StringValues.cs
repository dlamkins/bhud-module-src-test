...
namespace Microsoft.Extensions.Primitives
{
	...
	internal readonly struct StringValues : IList<string?>, ICollection<string?>, IEnumerable<string?>, IEnumerable, IReadOnlyList<string?>, IReadOnlyCollection<string?>, IEquatable<StringValues>, IEquatable<string?>, IEquatable<string?[]?>
	{
		...
		{
			[CompilerGenerated]
			private StringValues _003Cvalues_003EP;

			[DebuggerBrowsable(DebuggerBrowsableState.RootHidden)]
			public string[] Items => _003Cvalues_003EP.ToArray();
		...
		private string GetStringValue()
		{
			...
			static string? GetJoinedStringValueFromArray(string?[]? values)
			{
				...
				_003C98daa731_002Da0bb_002D4d8f_002Db014_002De6171dba4524_003EValueStringBuilder _003C98daa731_002Da0bb_002D4d8f_002Db014_002De6171dba4524_003EValueStringBuilder = new _003C98daa731_002Da0bb_002D4d8f_002Db014_002De6171dba4524_003EValueStringBuilder(num);
				bool flag = false;
				for (int j = 0; j < values!.Length; j++)
				{
					...
					if (text3 != null && text3.Length > 0)
					{
						if (flag)
						{
							_003C98daa731_002Da0bb_002D4d8f_002Db014_002De6171dba4524_003EValueStringBuilder.Append(',');
						}
						_003C98daa731_002Da0bb_002D4d8f_002Db014_002De6171dba4524_003EValueStringBuilder.Append(text3);
						flag = true;
					}
				}
				return _003C98daa731_002Da0bb_002D4d8f_002Db014_002De6171dba4524_003EValueStringBuilder.ToString();
			}
		...
		public override int GetHashCode()
		{
			...
			if (array != null)
			{
				...
				for (int i = 0; i < array.Length; i++)
				{
					num = _003C98daa731_002Da0bb_002D4d8f_002Db014_002De6171dba4524_003EHashHelpers.Combine(num, array[i]?.GetHashCode() ?? 0);
				}
				return num;
			}
