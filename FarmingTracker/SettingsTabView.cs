...
namespace FarmingTracker
{
	public class SettingsTabView : View
	{
		...
		protected override async void Build(Container buildPanel)
		{
			...
			SettingsFlowPanel parent2 = new SettingsFlowPanel((Container)(object)rootFlowPanel, "Profit");
			new SettingControl((Container)(object)parent2, (SettingEntry)(object)_services.SettingService.TotalProfitLabelTextSetting);
			new SettingControl((Container)(object)parent2, (SettingEntry)(object)_services.SettingService.ProfitPerHourLabelTextSetting);
			SettingsFlowPanel parent3 = new SettingsFlowPanel((Container)(object)rootFlowPanel, "Profit window");
			new FixedWidthHintLabel((Container)(object)parent3, 480, "A small window which shows the profit. Is is permanently visible even when the main farming tracker window is not visible.");
