	...
	public class SortService
	{
		...
		private static IOrderedEnumerable<Stat> ItemOrderBy(IOrderedEnumerable<Stat> items, SortByWithDirection sortByWithDirection)
		{
			...
			case SortByWithDirection.Count_Ascending:
				return items.ThenBy<Stat, long>((Stat i) => i.Signed_Count.Value);
			case SortByWithDirection.Count_Descending:
				return items.ThenByDescending<Stat, long>((Stat i) => i.Signed_Count.Value);
			...
			case SortByWithDirection.ProfitAll_Ascending:
				return items.ThenBy<Stat, long>((Stat i) => i.Signed_Count.Value * i.Profit.Unsigned_Max_ProfitInCopper);
			case SortByWithDirection.ProfitAll_Descending:
				return items.ThenByDescending<Stat, long>((Stat i) => i.Signed_Count.Value * i.Profit.Unsigned_Max_ProfitInCopper);
			case SortByWithDirection.ProfitPerItem_Ascending:
				return items.ThenBy<Stat, long>((Stat i) => i.CountSign * i.Profit.Unsigned_Max_ProfitInCopper);
			case SortByWithDirection.ProfitPerItem_Descending:
				return items.ThenByDescending<Stat, long>((Stat i) => i.CountSign * i.Profit.Unsigned_Max_ProfitInCopper);
			case SortByWithDirection.VendorProfitAll_Ascending:
				return items.ThenBy<Stat, long>((Stat i) => i.Signed_Count.Value * i.Profit.Unsigned_Vendor_ProfitInCopper.Value);
			case SortByWithDirection.VendorProfitAll_Descending:
				return items.ThenByDescending<Stat, long>((Stat i) => i.Signed_Count.Value * i.Profit.Unsigned_Vendor_ProfitInCopper.Value);
			case SortByWithDirection.VendorProfitPerItem_Ascending:
				return items.ThenBy<Stat, long>((Stat i) => i.CountSign * i.Profit.Unsigned_Vendor_ProfitInCopper.Value);
			case SortByWithDirection.VendorProfitPerItem_Descending:
				return items.ThenByDescending<Stat, long>((Stat i) => i.CountSign * i.Profit.Unsigned_Vendor_ProfitInCopper.Value);
			case SortByWithDirection.TradingPostProfitAll_Ascending:
				return items.ThenBy<Stat, long>((Stat i) => i.Signed_Count.Value * i.Profit.Unsigned_MaxTp_ProfitInCopper.Value);
			case SortByWithDirection.TradingPostProfitAll_Descending:
				return items.ThenByDescending<Stat, long>((Stat i) => i.Signed_Count.Value * i.Profit.Unsigned_MaxTp_ProfitInCopper.Value);
			case SortByWithDirection.TradingPostProfitPerItem_Ascending:
				return items.ThenBy<Stat, long>((Stat i) => i.CountSign * i.Profit.Unsigned_MaxTp_ProfitInCopper.Value);
			case SortByWithDirection.TradingPostProfitPerItem_Descending:
				return items.ThenByDescending<Stat, long>((Stat i) => i.CountSign * i.Profit.Unsigned_MaxTp_ProfitInCopper.Value);
			case SortByWithDirection.CustomProfitAll_Ascending:
				return items.ThenBy<Stat, long>((Stat i) => i.Signed_Count.Value * i.Profit.Unsigned_Custom_ProfitInCopper.GetValueOrDefault(0L));
			case SortByWithDirection.CustomProfitAll_Descending:
				return items.ThenByDescending<Stat, long>((Stat i) => i.Signed_Count.Value * i.Profit.Unsigned_Custom_ProfitInCopper.GetValueOrDefault(0L));
			case SortByWithDirection.CustomProfitPerItem_Ascending:
				return items.ThenBy<Stat, long>((Stat i) => i.CountSign * i.Profit.Unsigned_Custom_ProfitInCopper.GetValueOrDefault(0L));
			case SortByWithDirection.CustomProfitPerItem_Descending:
				return items.ThenByDescending<Stat, long>((Stat i) => i.CountSign * i.Profit.Unsigned_Custom_ProfitInCopper.GetValueOrDefault(0L));
			default:
