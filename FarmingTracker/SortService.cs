	...
	public class SortService
	{
		...
		private static IOrderedEnumerable<Stat> ItemOrderBy(IOrderedEnumerable<Stat> items, SortByWithDirection sortByWithDirection)
		{
			...
			case SortByWithDirection.Name_Ascending:
				return items.ThenBy((Stat i) => i.Details.Name);
			case SortByWithDirection.Name_Descending:
				return items.ThenByDescending((Stat i) => i.Details.Name);
			case SortByWithDirection.Rarity_Ascending:
				return items.ThenBy((Stat i) => i.Details.Rarity);
			case SortByWithDirection.Rarity_Descending:
				return items.ThenByDescending((Stat i) => i.Details.Rarity);
			case SortByWithDirection.Count_Ascending:
				return items.ThenBy((Stat i) => i.Count);
			case SortByWithDirection.Count_Descending:
				return items.ThenByDescending((Stat i) => i.Count);
			case SortByWithDirection.PositiveAndNegativeCount_Ascending:
				return items.ThenBy((Stat i) => i.CountSign);
			case SortByWithDirection.PositiveAndNegativeCount_Descending:
				return items.ThenByDescending((Stat i) => i.CountSign);
			case SortByWithDirection.ApiId_Ascending:
				return items.ThenBy((Stat i) => i.ApiId);
			case SortByWithDirection.ApiId_Descending:
				return items.ThenByDescending((Stat i) => i.ApiId);
			case SortByWithDirection.ItemType_Ascending:
				return items.ThenBy((Stat i) => i.Details.Type);
			case SortByWithDirection.ItemType_Descending:
				return items.ThenByDescending((Stat i) => i.Details.Type);
			case SortByWithDirection.ProfitAll_Ascending:
				return items.ThenBy((Stat i) => i.CountSign * i.Profits.All.MaxProfitInCopper);
			case SortByWithDirection.ProfitAll_Descending:
				return items.ThenByDescending((Stat i) => i.CountSign * i.Profits.All.MaxProfitInCopper);
			case SortByWithDirection.ProfitPerItem_Ascending:
				return items.ThenBy((Stat i) => i.CountSign * i.Profits.Each.MaxProfitInCopper);
			case SortByWithDirection.ProfitPerItem_Descending:
				return items.ThenByDescending((Stat i) => i.CountSign * i.Profits.Each.MaxProfitInCopper);
			case SortByWithDirection.VendorProfitAll_Ascending:
				return items.ThenBy((Stat i) => i.CountSign * i.Profits.All.VendorProfitInCopper);
			case SortByWithDirection.VendorProfitAll_Descending:
				return items.ThenByDescending((Stat i) => i.CountSign * i.Profits.All.VendorProfitInCopper);
			case SortByWithDirection.VendorProfitPerItem_Ascending:
				return items.ThenBy((Stat i) => i.CountSign * i.Profits.Each.VendorProfitInCopper);
			case SortByWithDirection.VendorProfitPerItem_Descending:
				return items.ThenByDescending((Stat i) => i.CountSign * i.Profits.Each.VendorProfitInCopper);
			case SortByWithDirection.TradingPostProfitAll_Ascending:
				return items.ThenBy((Stat i) => i.CountSign * i.Profits.All.MaxTpProfitInCopper);
			case SortByWithDirection.TradingPostProfitAll_Descending:
				return items.ThenByDescending((Stat i) => i.CountSign * i.Profits.All.MaxTpProfitInCopper);
			case SortByWithDirection.TradingPostProfitPerItem_Ascending:
				return items.ThenBy((Stat i) => i.CountSign * i.Profits.Each.MaxTpProfitInCopper);
			case SortByWithDirection.TradingPostProfitPerItem_Descending:
				return items.ThenByDescending((Stat i) => i.CountSign * i.Profits.Each.MaxTpProfitInCopper);
			default:
