...
namespace Lorf.BH.TTBlockersStuff.Settings
{
	internal class ColorPickerSettingView : SettingView<Color>
	{
		...
		public override bool HandleComplianceRequisite(IComplianceRequisite complianceRequisite)
		{
			...
			{
				SettingDisabledComplianceRequisite val = (SettingDisabledComplianceRequisite)(object)complianceRequisite;
				((Control)box).set_Enabled(!((SettingDisabledComplianceRequisite)(ref val)).get_Disabled());
				return true;
			}
			return false;
		}
