...
{
	internal class ColorPickerSettingView : SettingView<Gw2Sharp.WebApi.V2.Models.Color>
	{
		...
		public ColorPickerSettingView(SettingEntry<Gw2Sharp.WebApi.V2.Models.Color> setting, int definedWidth = -1)
