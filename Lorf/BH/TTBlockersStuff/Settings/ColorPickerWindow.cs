...
namespace Lorf.BH.TTBlockersStuff.Settings
{
	internal class ColorPickerWindow : Container, IWindow
	{
		...
		private int doABitOfMath(float size, bool height)
		{
			...
			float newSize = (height ? ((Control)this).get_Height() : ((Control)this).get_Width());
		...
		private void BuildChildElements()
		{
			...
			Label assignInputsLbl = val;
			StandardButton val2 = new StandardButton();
			val2.set_Text(Translations.ColorSelectionButtonTextCancel);
			((Control)val2).set_Location(new Point(((Control)this).get_Width() - textureMarginRight - 100 - 18, ((Control)this).get_Height() - textureMarginBottom - 18 - 25));
			((Control)val2).set_Width(100);
			((Control)val2).set_Height(25);
			((Control)val2).set_Parent((Container)(object)this);
			_cancelBttn = val2;
			StandardButton val3 = new StandardButton();
			val3.set_Text(Translations.ColorSelectionButtonTextOk);
			...
			((Control)picker).set_Size(new Point(((Control)this).get_Width() - ((Control)assignInputsLbl).get_Left() - 36, ((Control)_cancelBttn).get_Top() - ((Control)assignInputsLbl).get_Bottom() - 36));
			((Panel)picker).set_CanScroll(true);
			((Control)picker).set_Location(new Point(((Control)assignInputsLbl).get_Left(), ((Control)assignInputsLbl).get_Bottom() + 18));
		...
		public override void RecalculateLayout()
		{
			...
			if (parent != null)
			{
				...
				((Point)(ref distanceInwards))._002Ector(((Control)this)._size.X / 2 - _normalizedWindowRegion.Width / 2, ((Control)this)._size.Y / 2 - _normalizedWindowRegion.Height / 2);
				_windowRegion = RectangleExtension.OffsetBy(_normalizedWindowRegion, distanceInwards);
