	...
	public static class FractalExtensions
	{
		...
		public static string GetLabelShort(this Encounters.Fractal value)
		{
			return value switch
			{
				...
				Encounters.Fractal.ChaosFractal => "Chaos", 
				Encounters.Fractal.CliffsideFractal => "Cliff", 
				Encounters.Fractal.DeepstoneFractal => "Deeps", 
				...
				Encounters.Fractal.SunquaPeakFractal => "Sunqua", 
				Encounters.Fractal.SolidOceanFractal => "Ocean", 
				Encounters.Fractal.SwamplandFractal => "Swamp", 
				Encounters.Fractal.ThaumanovaReactorFractal => "Thau", 
				Encounters.Fractal.TwilightOasisFractal => "Twili", 
		...
		public static Encounters.Fractal GetFractalForScale(int scale)
		{
			return scale switch
			{
				...
				17 => Encounters.Fractal.SwamplandFractal, 
				...
				22 => Encounters.Fractal.MoltenFurnaceFractal, 
				23 => Encounters.Fractal.NightmareFractal, 
				24 => Encounters.Fractal.ShatteredObservatoryFractal, 
				25 => Encounters.Fractal.SunquaPeakFractal, 
				...
				44 => Encounters.Fractal.UncategorizedFractal, 
				45 => Encounters.Fractal.SolidOceanFractal, 
				46 => Encounters.Fractal.AetherbladeFractal, 
				47 => Encounters.Fractal.CliffsideFractal, 
				48 => Encounters.Fractal.NightmareFractal, 
				49 => Encounters.Fractal.ShatteredObservatoryFractal, 
				50 => Encounters.Fractal.SunquaPeakFractal, 
				...
				68 => Encounters.Fractal.SnowblindFractal, 
				69 => Encounters.Fractal.CliffsideFractal, 
				70 => Encounters.Fractal.MoltenBossFractal, 
				71 => Encounters.Fractal.AetherbladeFractal, 
				72 => Encounters.Fractal.CaptainMaiTrinBossFractal, 
				73 => Encounters.Fractal.NightmareFractal, 
				74 => Encounters.Fractal.ShatteredObservatoryFractal, 
				75 => Encounters.Fractal.SunquaPeakFractal, 
				...
				97 => Encounters.Fractal.ChaosFractal, 
				98 => Encounters.Fractal.NightmareFractal, 
				99 => Encounters.Fractal.ShatteredObservatoryFractal, 
