...
namespace SL.ChatLinks.Storage.Models.Hero.Achievements
{
	public sealed class AchievementEntityTypeConfiguration : IEntityTypeConfiguration<Achievement>
	{
		public void Configure(EntityTypeBuilder<Achievement> builder)
		{
			...
			builder.Property((Achievement achievement) => achievement.Tiers).HasJsonValueConversion();
			builder.Property((Achievement achievement) => achievement.Rewards).HasJsonValueConversion();
			builder.Property((Achievement achievement) => achievement.Bits).HasJsonValueConversion();
			builder.Property((Achievement achievement) => achievement.Prerequisites).HasJsonValueConversion();
