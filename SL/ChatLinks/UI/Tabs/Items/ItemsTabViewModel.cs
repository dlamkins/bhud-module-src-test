...
namespace SL.ChatLinks.UI.Tabs.Items
{
	public sealed class ItemsTabViewModel : ViewModel
	{
		...
		public void Initialize()
		{
			...
			_003CeventAggregator_003EP.Subscribe(new Func<DatabaseSeeded, ValueTask>(OnDatabaseSeeded));
		}
		...
		public void Unload()
		{
			...
			_003CeventAggregator_003EP.Unsubscribe<DatabaseSeeded>(new Func<DatabaseSeeded, ValueTask>(OnDatabaseSeeded));
		}
	}
}
