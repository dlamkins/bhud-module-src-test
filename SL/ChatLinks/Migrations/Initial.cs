...
namespace SL.ChatLinks.Migrations
{
	...
	public class Initial : Migration
	{
		...
		{
			migrationBuilder.CreateTable("Items", (ColumnsBuilder table) => new
			{
				Id = table.Column<int>(),
				...
				VendorValue = table.Column<int>(),
				GameTypes = table.Column<string>(),
				Flags = table.Column<string>(),
				Restrictions = table.Column<string>(),
				ChatLink = table.Column<string>(),
				IconHref = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				Type = table.Column<string>(),
				DefaultSkinId = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				WeightClass = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				Defense = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				InfusionSlots = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				AttributeAdjustment = table.Column<double>(null, null, null, rowVersion: false, null, nullable: true),
				AttributeCombinationId = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				Attributes = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				Buff = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				SuffixItemId = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				StatChoices = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				UpgradesInto = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				UpgradesFrom = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				NoSellOrSort = table.Column<bool>(null, null, null, rowVersion: false, null, nullable: true),
				Size = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				Effect = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				GuildUpgradeId = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				SkinIds = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				ColorId = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				RecipeId = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				ExtraRecipeIds = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				MiniatureId = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				Charges = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				UpgradeComponentFlags = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				InfusionUpgradeFlags = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				SuffixName = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				Bonuses = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				DamageType = table.Column<string>(null, null, null, rowVersion: false, null, nullable: true),
				MinPower = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				MaxPower = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true),
				SecondarySuffixItemId = table.Column<int>(null, null, null, rowVersion: false, null, nullable: true)
			}, null, table =>
			{
