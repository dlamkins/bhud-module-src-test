...
namespace SL.ChatLinks.Migrations
{
	...
	[Migration("20250201230707_MistChampions")]
	public class MistChampions : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.CreateTable("MistChampions", (ColumnsBuilder table) => new
			{
				Id = table.Column<int>().Annotation("Sqlite:Autoincrement", true),
				Name = table.Column<string>(),
				IconHref = table.Column<string>(),
				Default = table.Column<bool>(),
				UnlockItemIds = table.Column<string>()
			}, null, table =>
			{
				table.PrimaryKey("PK_MistChampions", x => x.Id);
			});
			migrationBuilder.CreateIndex("IX_MistChampions_Name", "MistChampions", "Name");
		}

		protected override void Down(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.DropTable("MistChampions");
		}

		protected override void BuildTargetModel(ModelBuilder modelBuilder)
		{
			modelBuilder.HasAnnotation("ProductVersion", "3.1.32");
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.Recipe", delegate(EntityTypeBuilder b)
			{
				...
				b.Property<string>("Ingredients").IsRequired().HasColumnType("TEXT");
				b.Property<int>("MinRating").HasColumnType("INTEGER");
				b.Property<int>("OutputItemCount").HasColumnType("INTEGER");
				b.Property<int>("OutputItemId").HasColumnType("INTEGER");
				b.Property<TimeSpan>("TimeToCraft").HasColumnType("TEXT");
			...
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Dyes.DyeColor", delegate(EntityTypeBuilder b)
			{
				b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
				b.Property<int>("BaseRgb").HasColumnType("INTEGER");
				b.Property<string>("Cloth").IsRequired().HasColumnType("TEXT");
				b.Property<string>("Fur").HasColumnType("TEXT");
				b.Property<string>("Hue").IsRequired().HasColumnType("TEXT");
				b.Property<int?>("ItemId").HasColumnType("INTEGER");
				b.Property<string>("Leather").IsRequired().HasColumnType("TEXT");
				b.Property<string>("Material").IsRequired().HasColumnType("TEXT");
				b.Property<string>("Metal").IsRequired().HasColumnType("TEXT");
				b.Property<string>("Name").IsRequired().HasColumnType("TEXT");
				b.Property<string>("Set").IsRequired().HasColumnType("TEXT");
				b.HasKey("Id");
				b.HasIndex("Hue");
				b.HasIndex("ItemId");
				b.HasIndex("Material");
			...
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Finishers.Finisher", delegate(EntityTypeBuilder b)
			{
				b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
				b.Property<string>("IconHref").IsRequired().HasColumnType("TEXT");
				b.Property<string>("LockedText").IsRequired().HasColumnType("TEXT");
				b.Property<string>("Name").IsRequired().HasColumnType("TEXT");
			...
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.EquipmentSkin", delegate(EntityTypeBuilder b)
			{
				...
				b.Property<string>("Name").IsRequired().HasColumnType("TEXT");
				b.Property<string>("Races").IsRequired().HasColumnType("TEXT");
			...
			modelBuilder.Entity("GuildWars2.Pvp.MistChampions.MistChampionSkin", delegate(EntityTypeBuilder b)
			{
				b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
				b.Property<bool>("Default").HasColumnType("INTEGER");
				b.Property<string>("IconHref").IsRequired().HasColumnType("TEXT");
				b.Property<string>("Name").IsRequired().HasColumnType("TEXT");
				b.Property<string>("UnlockItemIds").IsRequired().HasColumnType("TEXT");
				b.HasKey("Id");
				b.HasIndex("Name");
				b.ToTable("MistChampions");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.AmuletRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("amulet");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.AxeRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("axe");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.BackpackRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("backpack");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.BagRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("bag");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.BootsRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("boots");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.BulkRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("bulk");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.CoatRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("coat");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.ComponentRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("component");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.ConsumableRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("consumable");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.DaggerRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("dagger");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.DessertRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("dessert");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.DyeRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("dye");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.EarringRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("earring");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.FeastRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("feast");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.FocusRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("focus");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.GlovesRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("gloves");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.GreatswordRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("greatsword");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.GuildConsumableRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.Property<string>("GuildIngredients").IsRequired().HasColumnName("GuildConsumableRecipe_GuildIngredients")
					.HasColumnType("TEXT");
				b.Property<int>("OutputUpgradeId").HasColumnName("OutputUpgradeId").HasColumnType("INTEGER");
				b.HasDiscriminator().HasValue("guild_consumable");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.GuildDecorationRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.Property<string>("GuildIngredients").IsRequired().HasColumnName("GuildIngredients")
					.HasColumnType("TEXT");
				b.Property<int>("OutputUpgradeId").HasColumnName("OutputUpgradeId").HasColumnType("INTEGER");
				b.HasDiscriminator().HasValue("guild_decoration");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.GuildWvwUpgradeRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.Property<int?>("OutputUpgradeId").HasColumnName("OutputWvwUpgradeId").HasColumnType("INTEGER");
				b.HasDiscriminator().HasValue("guild_wvw_upgrade");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.HammerRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("hammer");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.HarpoonGunRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("harpoon_gun");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.HeadgearRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("headgear");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.IngredientCookingRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("ingredient_cooking");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.InscriptionRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("inscription");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.InsigniaRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("insignia");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.LegendaryComponentRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("legendary_component");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.LeggingsRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("leggings");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.LongbowRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("longbow");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.MaceRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("mace");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.MealRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("meal");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.PistolRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("pistol");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.PotionRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("potion");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.RefinementEctoplasmRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("refinement_ectoplasm");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.RefinementObsidianRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("refinement_obsidian");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.RefinementRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("refinement");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.RifleRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("rifle");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.RingRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("ring");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.ScepterRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("scepter");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.SeasoningRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("seasoning");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.ShieldRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("shield");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.ShortbowRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("shortbow");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.ShouldersRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("shoulders");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.SnackRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("snack");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.SoupRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("soup");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.SpearRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("spear");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.StaffRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("staff");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.SwordRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("sword");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.TorchRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("torch");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.TridentRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("trident");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.UpgradeComponentRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("upgrade_component");
			});
			modelBuilder.Entity("GuildWars2.Hero.Crafting.Recipes.WarhornRecipe", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Crafting.Recipes.Recipe");
				b.HasDiscriminator().HasValue("warhorn");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.ArmorSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.EquipmentSkin");
				b.Property<string>("DyeSlots").HasColumnType("TEXT");
				b.Property<string>("WeightClass").IsRequired().HasColumnType("TEXT");
				b.HasDiscriminator().HasValue("armor");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.BackpackSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.EquipmentSkin");
				b.HasDiscriminator().HasValue("back");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.GatheringToolSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.EquipmentSkin");
				b.HasDiscriminator().HasValue("gathering_tool");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.EquipmentSkin");
			...
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.BootsSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.ArmorSkin");
				b.HasDiscriminator().HasValue("boots");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.CoatSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.ArmorSkin");
				b.HasDiscriminator().HasValue("coat");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.GlovesSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.ArmorSkin");
				b.HasDiscriminator().HasValue("gloves");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.HelmAquaticSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.ArmorSkin");
				b.HasDiscriminator().HasValue("helm_aquatic");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.HelmSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.ArmorSkin");
				b.HasDiscriminator().HasValue("helm");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.LeggingsSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.ArmorSkin");
				b.HasDiscriminator().HasValue("leggings");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.ShouldersSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.ArmorSkin");
				b.HasDiscriminator().HasValue("shoulders");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.FishingToolSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.GatheringToolSkin");
				b.HasDiscriminator().HasValue("fishing_tool");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.ForagingToolSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.GatheringToolSkin");
				b.HasDiscriminator().HasValue("foraging_tool");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.LoggingToolSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.GatheringToolSkin");
				b.HasDiscriminator().HasValue("logging_tool");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.MiningToolSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.GatheringToolSkin");
				b.HasDiscriminator().HasValue("mining_tool");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.AxeSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("axe");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.DaggerSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("dagger");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.FocusSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("focus");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.GreatswordSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("greatsword");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.HammerSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("hammer");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.HarpoonGunSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("harpoon_gun");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.LargeBundleSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("large_bundle");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.LongbowSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("longbow");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.MaceSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("mace");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.PistolSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("pistol");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.RifleSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("rifle");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.ScepterSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("scepter");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.ShieldSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("shield");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.ShortbowSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("shortbow");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.SmallBundleSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("small_bundle");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.SpearSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("spear");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.StaffSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("staff");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.SwordSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("sword");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.TorchSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("torch");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.ToySkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("toy");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.ToyTwoHandedSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("toy_two_handed");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.TridentSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("trident");
			});
			modelBuilder.Entity("GuildWars2.Hero.Equipment.Wardrobe.WarhornSkin", delegate(EntityTypeBuilder b)
			{
				b.HasBaseType("GuildWars2.Hero.Equipment.Wardrobe.WeaponSkin");
				b.HasDiscriminator().HasValue("warhorn");
			});
