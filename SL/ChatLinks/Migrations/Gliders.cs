...
namespace SL.ChatLinks.Migrations
{
	...
	[Migration("20250201215820_Gliders")]
	public class Gliders : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.CreateTable("Gliders", (ColumnsBuilder table) => new
			{
				...
				DefaultDyeColorIds = table.Column<string>()
			}, null, table =>
			{
				table.PrimaryKey("PK_Gliders", x => x.Id);
			});
			migrationBuilder.CreateIndex("IX_Gliders_Name", "Gliders", "Name");
			migrationBuilder.CreateIndex("IX_Gliders_Order", "Gliders", "Order");
		}

		protected override void Down(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.DropTable("Gliders");
		}
