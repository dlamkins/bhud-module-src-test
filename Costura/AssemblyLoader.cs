...
namespace Costura
{
	...
	internal static class AssemblyLoader
	{
		...
		{
			checksums.Add("costura_win_x86.sliekens.e_sqlite3.dll", "964706035BB1C9D2DE9E113C218B1C829E7D3067");
			checksums.Add("costura_win_x64.sliekens.e_sqlite3.dll", "8C672384C19F3C226E59D5DA2A1073AFC0B85A7A");
		...
		public static void Attach(bool subscribe)
		{
			...
			string md5Hash = "C0A8C1DC41AE103E510F032A703B98D3";
