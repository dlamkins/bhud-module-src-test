...
namespace Costura
{
	...
	internal static class AssemblyLoader
	{
		...
		{
			assemblyNames.Add("adhesive", "costura.adhesive.dll.compressed");
			assemblyNames.Add("asyncclipboardservice", "costura.asyncclipboardservice.dll.compressed");
			symbolNames.Add("asyncclipboardservice", "costura.asyncclipboardservice.pdb.compressed");
			assemblyNames.Add("costura", "costura.costura.dll.compressed");
			assemblyNames.Add("de.humanizer.resources", "costura.de.humanizer.resources.dll.compressed");
			assemblyNames.Add("es.humanizer.resources", "costura.es.humanizer.resources.dll.compressed");
			assemblyNames.Add("fr.humanizer.resources", "costura.fr.humanizer.resources.dll.compressed");
			assemblyNames.Add("gw2sharp", "costura.gw2sharp.dll.compressed");
			assemblyNames.Add("humanizer", "costura.humanizer.dll.compressed");
			...
			assemblyNames.Add("zh-CN.humanizer.resources", "costura.zh-CN.humanizer.resources.dll.compressed");
		}
