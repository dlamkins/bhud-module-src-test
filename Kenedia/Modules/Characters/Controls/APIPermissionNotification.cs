...
namespace Kenedia.Modules.Characters.Controls
{
	public class APIPermissionNotification : BaseNotification
	{
		...
		public override void RecalculateLayout()
		{
			...
			string wrappedText = TextUtil.WrapText(GameService.Content.get_DefaultFont14(), strings.APIPermissionNotification, width);
		...
		protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds)
		{
			...
			SpriteBatchExtensions.DrawStringOnCtrl(spriteBatch, (Control)(object)this, strings.APIPermissionNotification, GameService.Content.get_DefaultFont14(), _textRectangle, Color.get_White(), true, (HorizontalAlignment)0, (VerticalAlignment)1);
