	...
	public class BasicTooltip : Control
	{
		...
		protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds)
		{
			...
			if (Font != null && Text != null)
			{
				...
				SpriteBatchExtensions.DrawStringOnCtrl(spriteBatch, (Control)(object)this, Text, Font, bounds, Color.get_White(), false, (HorizontalAlignment)1, (VerticalAlignment)1);
