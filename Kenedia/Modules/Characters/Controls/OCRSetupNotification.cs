...
namespace Kenedia.Modules.Characters.Controls
{
	public class OCRSetupNotification : BaseNotification
	{
		...
		public override void RecalculateLayout()
		{
			...
			string wrappedText = TextUtil.WrapText(GameService.Content.get_DefaultFont14(), string.Format(strings.OCRNotification, Resolution), width);
		...
		protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds)
		{
			...
			SpriteBatchExtensions.DrawStringOnCtrl(spriteBatch, (Control)(object)this, string.Format(strings.OCRNotification, Resolution), GameService.Content.get_DefaultFont14(), _textRectangle, Color.get_White(), true, (HorizontalAlignment)0, (VerticalAlignment)1);
