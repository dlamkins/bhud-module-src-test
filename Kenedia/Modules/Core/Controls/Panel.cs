	...
	public class Panel : Panel, ILocalizable
	{
		...
		public override void PaintBeforeChildren(SpriteBatch spriteBatch, Rectangle bounds)
		{
			...
			if (!string.IsNullOrEmpty(base._title))
			{
				...
				if (TitleIcon != null)
				{
					SpriteBatchExtensions.DrawOnCtrl(spriteBatch, (Control)(object)this, AsyncTexture2D.op_Implicit(TitleIcon), _layoutHeaderIconBounds, (Rectangle?)(Rectangle)(((_003F?)TitleTextureRegion) ?? TitleIcon.get_Bounds()), Color.get_White());
				}
