...
namespace Kenedia.Modules.Core.Controls
{
	public class TabButton : Control
	{
		...
		protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds)
		{
			...
			spriteBatch.DrawOnCtrl(this, ContentService.Textures.Pixel, bounds, Rectangle.Empty, bgColor * (base.MouseOver ? 0.35f : 0.55f));
			if (Icon != null)
			{
				...
				spriteBatch.DrawOnCtrl(this, Active ? Icon : (UseGrayScale ? IconGrayScale : Icon), new Rectangle(2 + (bounds.Width - size) / 2, 3, size, size), tRect, Active ? Color.White : new Color(75, 75, 75), 0f, default(Vector2));
			}
