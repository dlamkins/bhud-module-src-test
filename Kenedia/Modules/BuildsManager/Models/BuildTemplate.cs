...
namespace Kenedia.Modules.BuildsManager.Models
{
	public class BuildTemplate : IDisposable
	{
		...
		public string ParseBuildCode()
		{
			...
			if (Profession != null)
			{
				BuildChatLink val = new BuildChatLink();
				val.set_Profession((ProfessionType)Enum.Parse(typeof(ProfessionType), Profession.Id));
				build = val;
		...
		public BuildTemplate(string code = null)
		{
			...
			if (code != null)
			{
				...
				Profession = BuildsManager.s_moduleInstance.Data.Professions.Find(delegate(API.Profession e)
				{
