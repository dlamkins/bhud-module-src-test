...
namespace Kenedia.Modules.BuildsManager.Controls_Old.GearPage.GearSlots
{
	public class AmuletSlot : GearSlot
	{
		...
		public AmuletSlot(TemplateSlotType gearSlot, Container parent, TemplatePresenter templatePresenter, SelectionPanel selectionPanel)
			: base(gearSlot, parent, templatePresenter, selectionPanel)
		{
			...
			base.ItemControl.Item = BuildsManager.Data.Trinkets[92991];
		...
		protected override void OnClick(MouseEventArgs e)
		{
			...
			if (base.ItemControl.MouseOver)
			{
				...
				}, (base.TemplatePresenter?.Template[base.Slot] as AmuletTemplateEntry).Amulet?.StatChoices, (base.TemplatePresenter?.Template[base.Slot] as AmuletTemplateEntry).Amulet?.AttributeAdjustment);
			}
