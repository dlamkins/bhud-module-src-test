...
namespace Kenedia.Modules.BuildsManager.Controls_Old.GearPage.GearSlots
{
	public class RingSlot : GearSlot
	{
		...
		public Infusion? Infusion3
		{
			...
			set
			{
				Common.SetProperty(_003CInfusion3_003Ek__BackingField, value, delegate(Infusion v)
				{
					_003CInfusion3_003Ek__BackingField = v;
				}, new ValueChangedEventHandler<Infusion>(OnInfusion3Changed));
			}
		}
