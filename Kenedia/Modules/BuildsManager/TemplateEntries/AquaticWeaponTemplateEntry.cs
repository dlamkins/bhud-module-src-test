...
namespace Kenedia.Modules.BuildsManager.TemplateEntries
{
	public class AquaticWeaponTemplateEntry : TemplateEntry, IDisposable, IStatTemplateEntry, IDoubleSigilTemplateEntry, ISingleSigilTemplateEntry, IDoubleInfusionTemplateEntry, ISingleInfusionTemplateEntry, IWeaponTemplateEntry
	{
		...
		public AquaticWeaponTemplateEntry(TemplateSlotType slot)
			: base(slot)
		{
		}
		...
		{
			return array.Concat(new byte[6]
			{
		...
		public override byte[] GetFromCodeArray(byte[] array)
		{
			...
			if (array2 != null && array2.Length != 0)
			{
				...
				Sigil2 = BuildsManager.Data.PveSigils.Items.Where<KeyValuePair<int, Sigil>>((KeyValuePair<int, Sigil> e) => e.Value.MappedId == array2[3]).FirstOrDefault().Value;
				...
				Infusion2 = BuildsManager.Data.Infusions.Items.Where<KeyValuePair<int, Infusion>>((KeyValuePair<int, Infusion> e) => e.Value.MappedId == array2[5]).FirstOrDefault().Value;
			}
			if (array2 == null || array2.Length == 0)
			{
				return array2;
