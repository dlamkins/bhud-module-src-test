...
namespace Kenedia.Modules.BuildsManager.Controls
{
	public class Control_Build : Control
	{
		...
		private readonly int _MiddleRowTop = 47;
		...
		private readonly int Build_Height = 575;
			...
			: this()
		{
			...
			_PlaceHolderTexture = BuildsManager.s_moduleInstance.TextureManager._Icons[1];
			_EmptyTexture = BuildsManager.s_moduleInstance.TextureManager._Icons[0];
		...
		{
			_ = BuildsManager.s_moduleInstance.Selected_Template;
		}
	}
}
