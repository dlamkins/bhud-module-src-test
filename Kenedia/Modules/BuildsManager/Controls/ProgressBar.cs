...
namespace Kenedia.Modules.BuildsManager.Controls
{
	public class ProgressBar : Panel
	{
			...
			: this()
		{
			...
			val.set_Texture(AsyncTexture2D.op_Implicit(BuildsManager.s_moduleInstance.TextureManager.getControlTexture(ControlTexture.GlidingFill_Gray)));
			...
			val3.set_Texture(AsyncTexture2D.op_Implicit(BuildsManager.s_moduleInstance.TextureManager.getControlTexture(ControlTexture.GlidingFill)));
			_FilledTexture = val3;
