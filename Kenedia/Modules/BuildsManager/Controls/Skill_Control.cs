	...
	public class Skill_Control : Control
	{
		...
		public double Scale
		{
			...
			set
			{
				...
				_Scale = value;
				((Control)this).set_Size(PointExtension.Scale(new Point(_SkillSize, _SkillSize + 15), value));
			...
			: this()
		{
			...
			_SelectorTexture = Texture2DExtension.GetRegion(BuildsManager.s_moduleInstance.TextureManager.getControlTexture(ControlTexture.SkillSelector), 0, 2, 64, 12);
			...
			_SkillPlaceHolder = Texture2DExtension.GetRegion(BuildsManager.s_moduleInstance.TextureManager.getControlTexture(ControlTexture.PlaceHolder_Traitline), 0, 0, 128, 128);
		...
		protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds)
		{
			...
			Rectangle skillRect = RectangleExtension.Scale(new Rectangle(new Point(0, 12), new Point(((Control)this).get_Width(), ((Control)this).get_Height() - 12)), Scale);
			SpriteBatchExtensions.DrawOnCtrl(spriteBatch, (Control)(object)this, ((Control)this).get_MouseOver() ? _SelectorTextureHovered : _SelectorTexture, RectangleExtension.Scale(new Rectangle(new Point(0, 0), new Point(((Control)this).get_Width(), 12)), Scale), (Rectangle?)_SelectorTexture.get_Bounds(), Color.get_White(), 0f, default(Vector2), (SpriteEffects)0);
