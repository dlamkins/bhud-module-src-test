...
namespace Kenedia.Modules.BuildsManager.Controls
{
	public class ControlTemplateSelection : FlowPanel
	{
		...
		private readonly List<Control_TemplateEntry> Templates = new List<Control_TemplateEntry>();
		...
		public void SetSelection()
		{
			...
			_ProfessionSelector.Professions.Add(BuildsManager.s_moduleInstance.Data.Professions.Find(delegate(API.Profession e)
			{
		...
		public void Refresh()
		{
			...
			{
				if (BuildsManager.s_moduleInstance.Templates.Find((Template e) => e == template.Template) == null)
				{
					((Control)template).Dispose();
					Templates.Remove(template);
				}
			}
			foreach (Template template2 in BuildsManager.s_moduleInstance.Templates)
			{
