...
namespace Kenedia.Modules.BuildsManager.Controls
{
	public class CustomTooltip : Control
	{
			...
			: this()
		{
			...
			Background = BuildsManager.s_moduleInstance.TextureManager._Backgrounds[2];
		...
		private void UpdateLayout()
		{
			...
			foreach (string ss in TooltipContent)
			{
		...
		protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds)
		{
			...
			if (Header != null && TooltipContent != null)
			{
				...
				SpriteBatchExtensions.DrawStringOnCtrl(spriteBatch, (Control)(object)this, string.Join(Environment.NewLine, TooltipContent), font, new Rectangle(10, 10 + (int)rect.Height + 15, ((Control)this).get_Width() - 20, ((Control)this).get_Height() - (10 + (int)rect.Height + 15)), ContentColor, true, (HorizontalAlignment)0, (VerticalAlignment)0);
			}
		}
