...
namespace Kenedia.Modules.BuildsManager.Controls.Tabs
{
	public class GearTab : Blish_HUD.Controls.Container
	{
		...
		public GearTab(TemplatePresenter templatePresenter, SelectionPanel selectionPanel, Data data)
		{
			...
			{
				{
					...
					new ArmorSlot(TemplateSlotType.Head, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.Shoulder,
					new ArmorSlot(TemplateSlotType.Shoulder, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.Chest,
					new ArmorSlot(TemplateSlotType.Chest, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.Hand,
					new ArmorSlot(TemplateSlotType.Hand, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.Leg,
					new ArmorSlot(TemplateSlotType.Leg, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.Foot,
					new ArmorSlot(TemplateSlotType.Foot, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.MainHand,
					new WeaponSlot(TemplateSlotType.MainHand, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.OffHand,
					new WeaponSlot(TemplateSlotType.OffHand, this, TemplatePresenter, SelectionPanel)
					{
						Height = 55
					}
				},
				{
					...
					new WeaponSlot(TemplateSlotType.AltMainHand, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.AltOffHand,
					new WeaponSlot(TemplateSlotType.AltOffHand, this, TemplatePresenter, SelectionPanel)
					{
						Height = 55
					}
				},
				{
					...
					new ArmorSlot(TemplateSlotType.AquaBreather, this, TemplatePresenter, SelectionPanel)
					{
						Height = 55
					}
				},
				{
					...
					new AquaticWeaponSlot(TemplateSlotType.Aquatic, this, TemplatePresenter, SelectionPanel)
					{
						Height = 55
					}
				},
				{
					...
					new AquaticWeaponSlot(TemplateSlotType.AltAquatic, this, TemplatePresenter, SelectionPanel)
					{
						Height = 55
					}
				},
				{
					...
					new BackSlot(TemplateSlotType.Back, this, TemplatePresenter, SelectionPanel)
					{
						Width = 85
					}
				},
				{
					...
					new AmuletSlot(TemplateSlotType.Amulet, this, TemplatePresenter, SelectionPanel)
					{
						Width = 85
					}
				},
				{
					...
					new RingSlot(TemplateSlotType.Ring_1, this, TemplatePresenter, SelectionPanel)
					{
						Width = 85
					}
				},
				{
					...
					new RingSlot(TemplateSlotType.Ring_2, this, TemplatePresenter, SelectionPanel)
					{
						Width = 85
					}
				},
				{
					...
					new AccessoireSlot(TemplateSlotType.Accessory_1, this, TemplatePresenter, SelectionPanel)
					{
						Width = 85
					}
				},
				{
					...
					new AccessoireSlot(TemplateSlotType.Accessory_2, this, TemplatePresenter, SelectionPanel)
					{
						Width = 85
					}
				},
				{
					...
					new PvpAmuletSlot(TemplateSlotType.PvpAmulet, this, TemplatePresenter, SelectionPanel)
					{
						Visible = false
					}
				},
				{
					...
					new NourishmentSlot(TemplateSlotType.Nourishment, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.Enhancement,
					new EnhancementSlot(TemplateSlotType.Enhancement, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.PowerCore,
					new PowerCoreSlot(TemplateSlotType.PowerCore, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.PveRelic,
					new RelicSlot(TemplateSlotType.PveRelic, this, TemplatePresenter, SelectionPanel)
				},
				{
					TemplateSlotType.PvpRelic,
					new RelicSlot(TemplateSlotType.PvpRelic, this, TemplatePresenter, SelectionPanel)
				}
			};
			...
			_professionRaceSelection = new ProfessionRaceSelection
			{
				Parent = this,
				Visible = false,
				ClipsBounds = false,
