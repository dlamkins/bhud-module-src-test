...
namespace Kenedia.Modules.BuildsManager.Controls
{
	public class Control_TemplateEntry : Control
	{
		...
		private void OnTemplateChangedEvent(Template template)
		{
			...
			if (code != null && code != string.Empty && ((Enum)Control.get_Input().get_Keyboard().get_ActiveModifiers()).HasFlag((Enum)(object)(ModifierKeys)1))
			{
				try
				{
		...
		protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds)
		{
			...
			SpriteBatchExtensions.DrawOnCtrl(spriteBatch, (Control)(object)this, Textures.get_Pixel(), bounds, (Rectangle?)bounds, (BuildsManager.s_moduleInstance.Selected_Template == Template) ? new Color(0, 0, 0, 200) : new Color(0, 0, 0, 145), 0f, Vector2.get_Zero(), (SpriteEffects)0);
			...
			else
			{
				...
				_003F val4;
				if (BuildsManager.s_moduleInstance.Selected_Template != Template)
				{
