	...
	public class Skill : IDisposable, IBaseApiData, IDataMember
	{
		...
		public static int GetRevPaletteId(int id)
		{
			foreach (KeyValuePair<int, List<int>> pair in new Dictionary<int, List<int>>
			{
				{
					4572,
					new List<int> { 26937, 27220, 27372, 28219, 28427, 29148, 45686, 62719, 62749, 77043 }
				},
				{
					4614,
					new List<int> { 26821, 27322, 28379, 28516, 29209, 29310, 42949, 62832, 627020, 77243 }
				},
				{
					4651,
					new List<int> { 26679, 27014, 27025, 27505, 28231, 29082, 40485, 62962, 62941, 77291 }
				},
				{
					4564,
					new List<int> { 26557, 26644, 27107, 27715, 27917, 29197, 41220, 62878, 62796, 76805 }
				},
				{
					4554,
					new List<int> { 27356, 27760, 27975, 28287, 28406, 29114, 45773, 62942, 62687, 77001 }
				}
			})
			{
