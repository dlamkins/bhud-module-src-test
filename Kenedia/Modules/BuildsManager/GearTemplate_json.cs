...
namespace Kenedia.Modules.BuildsManager
{
	public class GearTemplate_json
	{
		...
		{
			new Weapon_TemplateItem_json
			{
				_Slot = "Weapon1_MainHand"
			},
			new Weapon_TemplateItem_json
			{
				_Slot = "Weapon1_OffHand"
			},
			new Weapon_TemplateItem_json
			{
				_Slot = "Weapon2_MainHand"
			},
			new Weapon_TemplateItem_json
			{
				_Slot = "Weapon2_OffHand"
			}
		};

		public List<AquaticWeapon_TemplateItem_json> AquaticWeapons = new List<AquaticWeapon_TemplateItem_json>
		{
			new AquaticWeapon_TemplateItem_json
			{
				_Slot = "AquaticWeapon1"
			},
			new AquaticWeapon_TemplateItem_json
			{
				_Slot = "AquaticWeapon2"
			}
		};
	}
}
