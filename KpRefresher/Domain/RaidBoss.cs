...
namespace KpRefresher.Domain
{
	public enum RaidBoss
	{
		...
		[Wing(1)]
		gorseval,
		[Display(Name = "Sabetha", Description = "sabetha", ResourceType = typeof(raidboss))]
		[FinalBoss]
		[Wing(1)]
		sabetha,
		...
		[Wing(2)]
		bandit_trio,
		[Display(Name = "Matthias", Description = "matthias", ResourceType = typeof(raidboss))]
		[FinalBoss]
		[Wing(2)]
		matthias,
		...
		[Wing(3)]
		twisted_castle,
		[Display(Name = "Xera", Description = "xera", ResourceType = typeof(raidboss))]
		[FinalBoss]
		[Wing(3)]
		xera,
		...
		[Wing(4)]
		samarog,
		[Display(Name = "Deimos", Description = "deimos", ResourceType = typeof(raidboss))]
		[FinalBoss]
		[Wing(4)]
		deimos,
		...
		[Wing(5)]
		statues_of_grenth,
		[Display(Name = "Voice In The Void", Description = "voice_in_the_void", ResourceType = typeof(raidboss))]
		[FinalBoss]
		[Wing(5)]
		voice_in_the_void,
		...
		[Wing(6)]
		twin_largos,
		[Display(Name = "Qadim", Description = "qadim", ResourceType = typeof(raidboss))]
		[FinalBoss]
		[Wing(6)]
		qadim,
		...
		[Wing(7)]
		sabir,
		[Display(Name = "Qadim The Peerless", Description = "qadim_the_peerless", ResourceType = typeof(raidboss))]
		[FinalBoss]
		[Wing(7)]
		qadim_the_peerless,
		...
		[Wing(8)]
		decima,
		[Display(Name = "Ura, the Steamshrieker", Description = "ura", ResourceType = typeof(raidboss))]
		[FinalBoss]
		[Wing(8)]
		ura
	}
