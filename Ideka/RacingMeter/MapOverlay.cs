...
namespace Ideka.RacingMeter
{
	public class MapOverlay : Control
	{
		public static class Data
		{
			...
			public static Vector2 WorldToMapScreen(Vector3 worldMeters)
			{
				//IL_000f: Unknown result type (might be due to invalid IL or missing references)
				//IL_0010: Unknown result type (might be due to invalid IL or missing references)
				return WorldToMapScreen(GameService.Gw2Mumble.get_CurrentMap().get_Id(), worldMeters);
			}

			public static Vector2 WorldToMapScreen(int mapId, Vector3 worldMeters)
			{
				...
				return WorldToMapScreen(mapId, worldMeters, MapCenter, Scale, MapRotation, BoundsCenter);
			}

			public static Vector2 WorldToMapScreen(int mapId, Vector3 worldMeters, Vector2 mapCenter, float scale, Matrix rotation, Vector2 boundsCenter)
			{
				//IL_0010: Unknown result type (might be due to invalid IL or missing references)
				//IL_0011: Unknown result type (might be due to invalid IL or missing references)
				//IL_0016: Unknown result type (might be due to invalid IL or missing references)
				...
				if (map != null)
				{
					return MapToMapScreen(map.WorldMetersToMap(worldMeters), mapCenter, scale, rotation, boundsCenter);
				}
				return Vector2.get_Zero();
			}

			public static Vector2 MapToMapScreen(Vector2 mapCoords)
			{
				...
				return MapToMapScreen(mapCoords, MapCenter, Scale, MapRotation, BoundsCenter);
			}

			public static Vector2 MapToMapScreen(Vector2 mapCoords, Vector2 mapCenter, float scale, Matrix rotation, Vector2 boundsCenter)
			{
				//IL_0000: Unknown result type (might be due to invalid IL or missing references)
				//IL_0001: Unknown result type (might be due to invalid IL or missing references)
				//IL_0002: Unknown result type (might be due to invalid IL or missing references)
