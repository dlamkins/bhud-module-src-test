...
{
	public abstract class RaceHolder : Control, IMapEntity
	{
		...
		public RaceHolder(bool screenMap)
			: this()
		{
			if (screenMap)
			{
				((Control)this).set_ClipsBounds(false);
				RacingModule.MapOverlay.AddEntity(this);
			}
		...
		public void DrawMapRacePoint(SpriteBatch spriteBatch, MapBounds map, RacePoint point, Color color, float radius = 10f)
		{
		...
		public void DrawMapLine(SpriteBatch spriteBatch, MapBounds map)
		{
		...
		public void DrawGhost(SpriteBatch spriteBatch, MapBounds map, GhostSnapshot snapshot, Color color)
		{
		...
		public abstract void DrawToMap(SpriteBatch spriteBatch, MapBounds map);

		protected override void DisposeControl()
		{
			RacingModule.MapOverlay.RemoveEntity(this);
