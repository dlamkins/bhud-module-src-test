...
namespace Nekres.Stopwatch.UI.Views
{
	public class CustomSettingsView : View<CustomSettingsPresenter>
	{
		...
		protected override void Build(Container buildPanel)
		{
			...
			((Control)val5).set_Size(new Point(160, 46));
			val5.set_Text("Set Position");
			((Control)val5).set_BasicTooltipText("Set the position of the timer on the user-interface.");
			((Control)val5).add_Click((EventHandler<MouseEventArgs>)OnPositionButtonClick);
		}
