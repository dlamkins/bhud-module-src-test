		...
		{
			{
				...
				new Bell2Note(Keys.None, Octaves.None)
			},
			{
				$"{Note.Keys.C}{Note.Octaves.Middle}",
				new Bell2Note(Keys.Note1, Octaves.Low)
			},
			{
				$"{Note.Keys.D}{Note.Octaves.Middle}",
				new Bell2Note(Keys.Note2, Octaves.Low)
			},
			{
				$"{Note.Keys.E}{Note.Octaves.Middle}",
				new Bell2Note(Keys.Note3, Octaves.Low)
			},
			{
				$"{Note.Keys.F}{Note.Octaves.Middle}",
				new Bell2Note(Keys.Note4, Octaves.Low)
			},
			{
				$"{Note.Keys.G}{Note.Octaves.Middle}",
				new Bell2Note(Keys.Note5, Octaves.Low)
			},
			{
				$"{Note.Keys.A}{Note.Octaves.Middle}",
				new Bell2Note(Keys.Note6, Octaves.Low)
			},
			{
				$"{Note.Keys.B}{Note.Octaves.Middle}",
				new Bell2Note(Keys.Note7, Octaves.Low)
			},
			{
				$"{Note.Keys.C}{Note.Octaves.High}",
				new Bell2Note(Keys.Note1, Octaves.High)
			},
			{
				$"{Note.Keys.D}{Note.Octaves.High}",
				new Bell2Note(Keys.Note2, Octaves.High)
			},
			{
				$"{Note.Keys.E}{Note.Octaves.High}",
				new Bell2Note(Keys.Note3, Octaves.High)
			},
			{
				$"{Note.Keys.F}{Note.Octaves.High}",
				new Bell2Note(Keys.Note4, Octaves.High)
			},
			{
				$"{Note.Keys.G}{Note.Octaves.High}",
				new Bell2Note(Keys.Note5, Octaves.High)
			},
			{
				$"{Note.Keys.A}{Note.Octaves.High}",
				new Bell2Note(Keys.Note6, Octaves.High)
			},
			{
				$"{Note.Keys.B}{Note.Octaves.High}",
				new Bell2Note(Keys.Note7, Octaves.High)
			},
			{
				$"{Note.Keys.C}{Note.Octaves.Highest}",
				new Bell2Note(Keys.Note8, Octaves.High)
			}
		};
