		...
		{
			{
				...
				new BassNote(Keys.None, Octaves.None)
			},
			{
				$"{Note.Keys.C}{Note.Octaves.Middle}",
				new BassNote(Keys.Note1, Octaves.Low)
			},
			{
				$"{Note.Keys.D}{Note.Octaves.Middle}",
				new BassNote(Keys.Note2, Octaves.Low)
			},
			{
				$"{Note.Keys.E}{Note.Octaves.Middle}",
				new BassNote(Keys.Note3, Octaves.Low)
			},
			{
				$"{Note.Keys.F}{Note.Octaves.Middle}",
				new BassNote(Keys.Note4, Octaves.Low)
			},
			{
				$"{Note.Keys.G}{Note.Octaves.Middle}",
				new BassNote(Keys.Note5, Octaves.Low)
			},
			{
				$"{Note.Keys.A}{Note.Octaves.Middle}",
				new BassNote(Keys.Note6, Octaves.Low)
			},
			{
				$"{Note.Keys.B}{Note.Octaves.Middle}",
				new BassNote(Keys.Note7, Octaves.Low)
			},
			{
				$"{Note.Keys.C}{Note.Octaves.Low}",
				new BassNote(Keys.Note1, Octaves.High)
			},
			{
				$"{Note.Keys.D}{Note.Octaves.Low}",
				new BassNote(Keys.Note2, Octaves.High)
			},
			{
				$"{Note.Keys.E}{Note.Octaves.Low}",
				new BassNote(Keys.Note3, Octaves.High)
			},
			{
				$"{Note.Keys.F}{Note.Octaves.Low}",
				new BassNote(Keys.Note4, Octaves.High)
			},
			{
				$"{Note.Keys.G}{Note.Octaves.Low}",
				new BassNote(Keys.Note5, Octaves.High)
			},
			{
				$"{Note.Keys.A}{Note.Octaves.Low}",
				new BassNote(Keys.Note6, Octaves.High)
			},
			{
				$"{Note.Keys.B}{Note.Octaves.Low}",
				new BassNote(Keys.Note7, Octaves.High)
			},
			{
				$"{Note.Keys.C}{Note.Octaves.Lowest}",
				new BassNote(Keys.Note8, Octaves.High)
			}
		};
