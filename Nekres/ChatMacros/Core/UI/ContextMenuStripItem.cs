...
namespace Nekres.ChatMacros.Core.UI
{
	internal class ContextMenuStripItem<T> : ContextMenuStripItem
	{
		...
		private readonly Texture2D _textureArrow = Control.get_Content().GetTexture("context-menu-strip-submenu");
		...
		public Color FontColor
		{
			...
			set
			{
				...
				((Control)this).SetProperty<Color>(ref _fontColor, value, false, "FontColor");
		...
		public ContextMenuStripItem(string text, T value)
			: this(text)
		{
			Value = value;
		}
