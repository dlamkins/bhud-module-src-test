...
namespace Nekres.Screenshot_Manager_Module.Controls
{
	public class ScreenshotNotification : Panel
	{
		...
		private static readonly BitmapFont _font = GameService.Content.GetFont((FontFace)0, (FontSize)24, (FontStyle)0);

		private static readonly BitmapFont _titleFont = GameService.Content.GetFont((FontFace)0, (FontSize)22, (FontStyle)0);
		...
		public override void PaintBeforeChildren(SpriteBatch spriteBatch, Rectangle bound)
		{
			...
			SpriteBatchExtensions.DrawStringOnCtrl(spriteBatch, (Control)(object)this, _message, _font, new Rectangle(0, 0, ((Control)this).get_Width(), 36), Color.get_White(), false, true, 2, (HorizontalAlignment)1, (VerticalAlignment)1);
		}
		...
		public override void PaintAfterChildren(SpriteBatch spriteBatch, Rectangle bound)
		{
			...
			SpriteBatchExtensions.DrawStringOnCtrl(spriteBatch, (Control)(object)this, "“" + Path.GetFileNameWithoutExtension(_thumbnail.FileName) + "”", _titleFont, new Rectangle(0, 38, ((Control)this).get_Width(), 36), Color.get_White(), false, true, 1, (HorizontalAlignment)1, (VerticalAlignment)1);
		}
