...
namespace Estreya.BlishHUD.Shared.Controls
{
	public class ControlMover : Control, IWindow
	{
		...
		public ControlMover(string description, Texture2D handleTexture, params ScreenRegion[] screenPositions)
			: this(description, screenPositions.ToList(), handleTexture)
		{
		}
