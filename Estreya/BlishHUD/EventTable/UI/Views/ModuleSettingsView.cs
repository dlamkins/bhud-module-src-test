...
namespace Estreya.BlishHUD.EventTable.UI.Views
{
	public class ModuleSettingsView : View
	{
		...
		protected override void Build(Container buildPanel)
		{
			...
			RenderSetting((Panel)(object)parentPanel, (SettingEntry)(object)ModuleSettings.GlobalEnabled);
			RenderSetting((Panel)(object)parentPanel, (SettingEntry)(object)ModuleSettings.GlobalEnabledHotkey);
			RenderSetting((Panel)(object)parentPanel, (SettingEntry)(object)ModuleSettings.HideOnMissingMumbleTicks);
			...
			RenderSetting((Panel)(object)parentPanel, (SettingEntry)(object)ModuleSettings.EventTimeSpan);
			RenderSetting((Panel)(object)parentPanel, (SettingEntry)(object)ModuleSettings.DrawEventBorder);
			RenderSetting((Panel)(object)parentPanel, (SettingEntry)(object)ModuleSettings.Opacity);
			RenderColorSetting((Panel)(object)parentPanel, ModuleSettings.TextColor);
			RenderEmptyLine((Panel)(object)parentPanel);
			RenderSetting((Panel)(object)parentPanel, (SettingEntry)(object)ModuleSettings.UseFiller);
			RenderSetting((Panel)(object)parentPanel, (SettingEntry)(object)ModuleSettings.UseFillerEventNames);
			RenderColorSetting((Panel)(object)parentPanel, ModuleSettings.FillerTextColor);
			RenderEmptyLine((Panel)(object)parentPanel);
			RenderSetting((Panel)(object)parentPanel, (SettingEntry)(object)ModuleSettings.BackgroundColorOpacity);
			RenderColorSetting((Panel)(object)parentPanel, ModuleSettings.BackgroundColor);
			RenderEmptyLine((Panel)(object)parentPanel);
		...
		private void RenderColorSetting(Panel parent, SettingEntry<Color> setting)
		{
