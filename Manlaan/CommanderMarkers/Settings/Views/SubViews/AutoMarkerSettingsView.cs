	...
	public class AutoMarkerSettingsView : View
	{
		...
		protected override void Build(Container buildPanel)
		{
			...
			FlowPanel panel = FlowPanelExtensions.BeginFlow(new FlowPanel(), buildPanel).AddString("AutoMarker Feature").AddString("Allows for rapidly placing saved marker sets")
				...
				.AddSetting((SettingEntry)(object)_settings.AutoMarker_Billboard_FeatureEnabled)
				.AddSetting((SettingEntry)(object)_settings.AutoMarker_Billboard_Placement)
				.AddSetting((SettingEntry)(object)_settings.AutoMarker_Billboard_Preview)
				.AddSpace()
				.AddSetting((SettingEntry)(object)_settings.AutoMarker_Allow_Combat_Placement)
				.AddSpace()
