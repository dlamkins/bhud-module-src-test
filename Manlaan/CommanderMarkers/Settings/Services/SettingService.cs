...
namespace Manlaan.CommanderMarkers.Settings.Services
{
	public class SettingService : IDisposable
	{
		...
		public SettingService(SettingCollection settings)
		{
			...
			AutoMarker_LibraryFilterToCurrent = settings.DefineSetting<bool>("CmdMrkAMLibraryFilter", false, (Func<string>)(() => "Current map"), (Func<string>)(() => "Filter the library list to only show marker sets for your current map"));
			AutoMarker_LibraryFilterMine = settings.DefineSetting<bool>("CmdMrkAMLibraryFilterMine", false, (Func<string>)(() => "Mine"), (Func<string>)(() => "Hide marker sets imported from the community library"));
			...
			RtApiIntegrationEnabled = settings.DefineSetting<bool>("CmdMrkRtApiEnabled", false, (Func<string>)(() => "Enable Raidcore.GG Nexus Real-Time API integration"), (Func<string>)(() => "Use RTAPI (via Nexus game memory reading) to import active squad marker positions in the library editor"));
