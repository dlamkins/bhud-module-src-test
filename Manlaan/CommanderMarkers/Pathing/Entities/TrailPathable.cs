	...
	public class TrailPathable : Entity
	{
		...
		public override void Update(GameTime gameTime)
		{
			...
			if (Visible && ShouldShow)
			{
				...
				try
				{
					_vertexBuffer = new VertexBuffer(((GraphicsDeviceContext)(ref graphicsDeviceContext)).get_GraphicsDevice(), VertexPositionColorTexture.VertexDeclaration, _vertexData.Length, (BufferUsage)1);
				}
				finally
				{
